 ...
 */
public class GmCard {
  private Long gcId; // 卡牌id
  private String gcName; // 卡牌名称
  private Short cardType; //卡牌类型
  private Short cardTypeDtl; // 卡牌详细类型
  private String imgUrl; // 图片地址
  private String remarks; // 卡牌描述
  private Short decor; // 花色
  ...
  // 判定牌
  private Short judgingType; // 判定类型（花色/卡牌点数/颜色）
